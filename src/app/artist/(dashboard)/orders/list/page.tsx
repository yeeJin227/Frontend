...
const initialRows: OrderRow[] = [
  { id: '0123157', statusText: '상품명입니다 상품명입니다', buyer: '홍길동 / honggildong', orderState: '결제 완료', requestAt: '2025-09-18' },
  { id: '0123156', statusText: '상품명입니다 상품명입니다', buyer: '홍길동 / honggildong', orderState: '배송 준비중', requestAt: '2025-09-18' },
  { id: '0123155', statusText: '상품명입니다 상품명입니다', buyer: '홍길동 / honggildong', orderState: '배송중', requestAt: '2025-09-18' },
  { id: '0123154', statusText: '상품명입니다 상품명입니다', buyer: '홍길동 / honggildong', orderState: '배송완료', requestAt: '2025-09-18' },
];
    ...
    <>
      <div className="mb-5 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline">주문 엑셀 다운로드</Button>
          <Button variant="primary">주문 상태 변경</Button>
        </div>
      </div>
      ...
      <AdminDataTable
        ...
        rows={
          searchTerm
            ? rows.filter((r) =>
                [r.id, r.statusText, r.buyer, r.orderState].some((v) =>
