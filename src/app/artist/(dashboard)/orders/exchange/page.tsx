...
type ExchangeRow = {
  ...
  statusText: string;
  buyer: string;
  requestState: string; // 교환 신청/교환 접수/완료 등
  requestAt: string;
};
...
const initialRows: ExchangeRow[] = [
  { id: '0123157', statusText: '상품명입니다 상품명입니다', buyer: '손영훈 / heroson02', requestState: '교환 신청', requestAt: '2025-09-18' },
  { id: '0123156', statusText: '상품명입니다 상품명입니다', buyer: '홍길동 / honggildong', requestState: '교환 접수', requestAt: '2025-09-18' },
  { id: '0123155', statusText: '상품명입니다 상품명입니다', buyer: '홍길동 / honggildong', requestState: '교환 처리중', requestAt: '2025-09-18' },
  { id: '0123154', statusText: '상품명입니다 상품명입니다', buyer: '홍길동 / honggildong', requestState: '교환 완료', requestAt: '2025-09-18' },
];
    ...
    <>
      <div className="mb-5 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline">교환 거부</Button>
          <Button variant="primary">교환 승인</Button>
        </div>
      </div>
      ...
      <AdminDataTable
        ...
        onSortChange={(k, d) => { setSortKey(k as keyof ExchangeRow); setSortDirection(d); }}
